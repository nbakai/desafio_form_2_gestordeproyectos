...
class ProyectosControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create proyecto" do
    assert_difference('Proyecto.count') do
      post proyectos_url, params: { proyecto: { description: @proyecto.description, end_date: @proyecto.end_date, name: @proyecto.name, start_date: @proyecto.start_date, state: @proyecto.state } }
    end
  ...
  test "should update proyecto" do
    patch proyecto_url(@proyecto), params: { proyecto: { description: @proyecto.description, end_date: @proyecto.end_date, name: @proyecto.name, start_date: @proyecto.start_date, state: @proyecto.state } }
